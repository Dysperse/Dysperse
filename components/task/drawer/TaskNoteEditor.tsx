...
const extensions = [
  StarterKit.configure({
    bold: { HTMLAttributes: { style: "font-family: 'body_700', 'Jost'" } },
  ...
  return (
    ...
    >
      ...
      <style>
        ...
        {`p.is-editor-empty:first-child::before{color:${theme[6]};content:attr(data-placeholder);font-family:'body_300', 'Jost';float:left;height:0;pointer-events:none}`}
